            ...
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url('grades')}}">{{trans('main-sidebar.gradeList')}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('classrooms')}}">{{trans('My_Classes_trans.List_classes')}} </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url('Sections.index')}}">{{trans('main_trans.List_sections')}}</a></li>
                        </ul>
                    </li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    ...
                                    <li> <a href="{{url('Students.index')}}">{{trans('main_trans.list_students')}}</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    <li> <a href="{{url('Promotion.index')}}">{{trans('main_trans.add_Promotion')}}</a></li>
                                    <li> <a href="{{url('Promotion.create')}}">{{trans('main_trans.list_Promotions')}}</a> </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul id="Graduate students" class="collapse">
                                    ...
                                    <li> <a href="{{url('Graduated.index')}}">{{trans('main_trans.list_Graduate')}}</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#chart">
                            <div class="pull-left"><i class="fa-solid fa-user-tie"></i></i><span
                                    class="right-nav-text">{{trans('main_trans.Parents')}}</span></div>
                           
                            <div class="clearfix"></div>
                        </a>
                        <ul id="chart" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('parent_Show')}}">{{trans('main_trans.List_Parents')}}</a> </li>
             ...
             <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('Fees.index')}}">الرسوم الدراسية</a> </li>
                            <li> <a href="{{url('Fees_Invoices.index')}}">الفواتير</a> </li>
                            <li> <a href="{{url('receipt_student.index')}}">سندات القبض</a> </li>
                            <li> <a href="{{url('ProcessingFee.index')}}">استبعاد رسوم</a> </li>
                            <li> <a href="{{url('Payment_students.index')}}">سندت الصرف</a> </li>
                        </ul>
                    </li>
                      ...
                      <li>
                        ...
                        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('Attendance.index')}}">قائمة الطلاب</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url('subjects.index')}}">قائمة المواد</a> </li>
                        </ul>
                    </li>
                    <!-- menu font icon-->
                    <li>
