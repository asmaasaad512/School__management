        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{url('Students.update')}}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Student->name('ar')}}" type="text" name="name_ar"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Student->name('en')}}" class="form-control" name="name_en" type="text" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_type_id">
                                        ...
                                        @foreach($bloods as $bg)
                                            <option value="{{ $bg->id }}" {{$bg->id == $Student->blood_type_id ? 'selected' : ""}}>{{ $bg->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                       ...
                                       @foreach($parents as $parent)
                                            <option value="{{ $parent->id }}" {{ $parent->id == $Student->my__parent_id ? 'selected' : ""}}>{{ $parent->Name_Father() }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
