    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('Promotion.destroy')}}" method="post">
                    @csrf
                    
                    <input type="hidden" name="id" value="{{$promotion->id}}">
                    <h5 style="font-family: 'Cairo', sans-serif;">هل انت متاكد من عملية رجوع الطالب الي المرحلة السابقة ؟ {{$promotion->student->name()}}</h5>
