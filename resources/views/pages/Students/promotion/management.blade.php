                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Delete_one{{$promotion->id}}">رجوع الطالب</button>
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#Graduated{{$promotion->id}}">تخرج الطالب</button>
                                                </td>
                                            </tr>
