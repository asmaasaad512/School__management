        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{url('Promotion.store') }}">
                        @csrf
                        <div class="form-row">
                ...
                if (Classroom_id) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('select[name="section_id"]').empty(); $('select[name="Classroom_id_new"]').append('<option selected disabled >{{trans('Parent_trans.Choose')}}...</option>');
                            $.each(data, function (key, value) {
