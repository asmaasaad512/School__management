            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{url('subjects.update')}}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" name="Grade_id">
                                            ...
                                            @foreach($grades as $grade)
                                                ...
                                                <option value="{{$grade->id}}" @if($grade->id == $subject->grade_id) selected  >  @endIf {{$grade->name()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        @foreach($teachers as $teacher)
                                                <option
                                                    value="{{$teacher->id}}" @if($teacher->id == $subject->teacher_id )selected > @endif {{$teacher->name()}}
                                                </option>
                                            @endforeach
                                        </select>                               
                                    </div>
