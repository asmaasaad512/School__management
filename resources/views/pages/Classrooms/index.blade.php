...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" class="button x-small" data-toggle="modal" data-target="#add_class">
            ...
            <br><br>
            <form action="{{ url('Filter_Classes') }}" method="POST">
             @csrf
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- add_form -->
                                            <form action="{{url('classrooms/update') }}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="text" name="name_en" class="form-control"
                                                            value="{{$My_Class->name('en')}}"
                                                             required>
                                                    </div>
                                                    <div class="col-6">
                                                    <div class="form-group">
                           <label for="category_id"> Grade Name</label>
                        <select class="custom-select form-control-border border-width-2"name='grade_id'>
                       @foreach($Grades as $Grade)
                     <option value="{{$Grade->id}}" @if($My_Class->grade_id == $Grade->id) selected  >  @endIf {{$Grade->name()}}</option>
                       @endforeach
</select>
 </div> 
                                                     </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-success">{{ trans('My_Classes_trans.Delete') }}</button>
                                                </div>
                                            </form>
                            ...
                            <div class="modal fade" id="delete{{ $My_Class->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('classrooms/destroy') }}" method="post">
...
<!-- add_modal_class -->
<div class="modal fade" id="add_class" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{ url('classrooms/store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="repeater">
                            ...
                            <div class="row mt-20">
                                <div class="col-12">
                                    <input  class="button"  type="button" value="{{ trans('My_Classes_trans.add_row') }}" data-repeater-create/>
                                </div>
