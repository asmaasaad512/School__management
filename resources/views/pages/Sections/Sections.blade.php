                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->name_Section('ar') }}">
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->name_Section('en') }}">
                                                                                                <input id="id"
                                                                                                       type="hidden"
                                                                                                       name="id"
                                                                                                       class="form-control"
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"
                                                                                                    class="custom-select">
                                                                                                <option
                                                                                                    value="{{ $list_Sections->classroom_id}}">
